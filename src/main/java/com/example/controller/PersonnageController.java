...
public class PersonnageController {
    ...
    @GetMapping("/characters"+ "?ts=" +Constantes.TS +"&apikey="+ Constantes.API_PUBLIC_KEY 
    		+ "&hash=" + Constantes.GENERIC_API_KEY)
    public List<Personnage> getAllPersonnage() {
        return personnageService.getPersonnages();
    }
    
    //Affichage d'un personnage par son Id
    @GetMapping("/characters/{characterId}" +"?ts=" +Constantes.TS +"&apikey="+ Constantes.API_PUBLIC_KEY 
    		+ "&hash=" + Constantes.GENERIC_API_KEY)
    ...
    @PostMapping("/characters" + "?ts=" +Constantes.TS +"&apikey="+ Constantes.API_PUBLIC_KEY 
    		+ "&hash=" + Constantes.GENERIC_API_KEY)
    ...
    @DeleteMapping("/characters/{characterId}"+ "?ts=" +Constantes.TS +"&apikey="+ Constantes.API_PUBLIC_KEY 
    		+ "&hash=" + Constantes.GENERIC_API_KEY)
    public Map<String, Boolean> deletePersonnage(@PathVariable(value = "characterId") Long personnageId)
    		throws ResourceNotFoundException{
